...
const MarketplaceLeadCard = ({ lead, onExpressInterest }: MarketplaceLeadCardProps) => {
  ...
  return (
    <Card className="group flex flex-col overflow-hidden border border-[#222121]/10 bg-white shadow-[0_2px_8px_rgba(0,0,0,0.04)] transition-all hover:border-violet-200 hover:shadow-lg">
      ...
      <CardFooter className="border-t border-[#222121]/5 bg-[#F7F7F7]/50 p-4">
        <Button
          ...
          className="w-full rounded-full bg-violet-600 text-sm font-semibold text-white shadow-[0_4px_12px_rgba(139,92,246,0.3)] transition-all hover:bg-violet-700 hover:shadow-[0_6px_16px_rgba(139,92,246,0.4)]"
        >
          Express Interest
        </Button>
      </CardFooter>
