      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Manage notification preferences for client users
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
          ...
          <Card className="bg-gradient-to-t from-blue-500/10 to-card shadow-sm">
            <CardContent className="p-6">
              <CardDescription className="text-xs font-medium text-muted-foreground uppercase tracking-wide mb-2">
                Total Users
              </CardDescription>
          ...
          <Card className="bg-gradient-to-t from-emerald-500/10 to-card shadow-sm">
            <CardContent className="p-6">
              <CardDescription className="text-xs font-medium text-muted-foreground uppercase tracking-wide mb-2">
                Notifications On
              </CardDescription>
          ...
          <Card className="bg-gradient-to-t from-slate-500/10 to-card shadow-sm">
            <CardContent className="p-6">
              <CardDescription className="text-xs font-medium text-muted-foreground uppercase tracking-wide mb-2">
                Notifications Off
              </CardDescription>
              <CardTitle className="text-2xl font-bold tabular-nums text-slate-600">
        ...
        {clients.length === 0 ? (
          ...
          <div className="space-y-4">
            {clients.map((client) => (
              <Card key={client.clientId} className="shadow-sm">
                <CardHeader className="pb-3">
                    ...
                    {client.users.map((user) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex items-center gap-2">
                            <Label htmlFor={`toggle-${user.id}`} className="text-xs text-muted-foreground">
                              Lead Emails
                            </Label>
                            <Switch
                              id={`toggle-${user.id}`}
