  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({
        ...
        contactLinkedIn: "", titlesOfRoles: "", aiSummary: "", repId: "",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Button
            ...
            size="lg"
            variant="ghost"
            className="w-full h-12 rounded-full bg-[#34B192] text-base font-semibold text-white shadow-[0_6px_18px_rgba(52,177,146,0.25)] transition-all hover:bg-[#2D9A7E]"
